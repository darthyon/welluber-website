      ...
      {meteorStyles.map((style, idx) => (
        <span
          ...
          className={cn(
            ...
            "before:absolute before:top-1/2 before:h-[1px] before:w-[50px] before:-translate-y-[50%] before:transform before:bg-gradient-to-r before:from-[#818CF8] before:to-transparent before:content-['']",
            className,
          )}
          style={style}
        />
