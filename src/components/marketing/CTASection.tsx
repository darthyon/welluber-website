...
export function CTASection() {
  ...
  return (
    <section ref={ref} className="relative overflow-hidden bg-[#1E1B2E] py-16 sm:py-20 lg:py-24">
      ...
      <Container className="relative">
        <BlurFade inView delay={0.1}>
          <div className="grid gap-10 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] lg:items-center lg:gap-12">
            {/* Left — copy */}
            <div>
              <p className="font-[family-name:var(--font-inter)] text-xs font-semibold uppercase tracking-[0.08em] text-[#818CF8]">
              ...
              <p className="mt-4 max-w-md font-[family-name:var(--font-inter)] text-base leading-relaxed text-[#9CA3B8]">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="rounded-xl border border-white/10 bg-white/5 px-5 py-4 shadow-lg backdrop-blur-sm">
                ...
                <p className="mt-1 font-[family-name:var(--font-inter)] text-sm text-[#9CA3B8]">
              ...
              <div className="rounded-xl border border-white/10 bg-white/5 px-5 py-4 shadow-lg backdrop-blur-sm">
                ...
                <div className="mt-3 h-1.5 w-full overflow-hidden rounded-full bg-[#EEF2FF]/10">
                  <div className="h-full w-[68%] rounded-full bg-[color:var(--color-brand)]" />
                </div>
                <div className="mt-1.5 flex justify-between">
                  <span className="font-[family-name:var(--font-inter)] text-[11px] text-[#9CA3B8]">
                    RM 136,000 spent
                  </span>
                  <span className="font-[family-name:var(--font-inter)] text-[11px] text-[#9CA3B8]">
                    of RM 200,000
